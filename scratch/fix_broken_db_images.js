...
const PLACEHOLDER_IMG = 'https://res.cloudinary.com/demo/image/upload/v1312461204/sample.jpg'; // Using Cloudinary's default sample image
...
async function fixBrokenImages() {
    ...
    try {
        ...
        for (const p of products) {
            let updateData = {};
            if (p.image && p.image.includes('/uploads/')) {
        ...
        for (const o of offers) {
            if (o.image && o.image.includes('/uploads/')) {
